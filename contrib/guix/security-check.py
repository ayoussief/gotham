...
def check_ELF_FORTIFY(binary) -> bool:
    ...
    # gotham-util does not currently contain any fortified functions
    if 'Gotham Core gotham-util utility version ' in binary.strings:
        return True
    # gotham wrapper does not currently contain any fortified functions
