...
(define* (make-gotham-cross-toolchain target
                                       #:key
...
desirable for building Gotham Core release binaries."
...
;; failure; see https://github.com/gotham/gotham/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-gotham-cross-toolchain target)))
