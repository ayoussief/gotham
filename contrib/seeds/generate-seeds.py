...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef GOTHAM_CHAINPARAMSSEEDS_H\n')
    g.write('#define GOTHAM_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the gotham network\n')
    ...
    g.write('#endif // GOTHAM_CHAINPARAMSSEEDS_H\n')
