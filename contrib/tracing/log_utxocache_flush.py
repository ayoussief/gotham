...
"""Example logging Gotham Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/gothamd
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[gothamd_with_usdts])
