...
complete --command gotham-qt --no-files

# Extract options
function __fish_gothamqt_get_options
...
complete \
    --command gotham-qt \
    --arguments "(__fish_gothamqt_get_options --nofiles)"
