...
complete --command gothamd --no-files

# Extract options
function __fish_gothamd_get_options
...
complete \
    --command gothamd \
    --arguments "(__fish_gothamd_get_options --nofiles)"
