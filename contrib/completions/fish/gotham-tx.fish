...
# Extract options
function __fish_gotham_tx_get_options
...
# Extract commands
function __fish_gotham_tx_get_commands
...
complete \
    --command gotham-tx \
    --condition "not __fish_gotham_seen_cmd (__fish_gotham_tx_get_commands --commandsonly)" \
    --arguments "(__fish_gotham_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command gotham-tx \
    --arguments "(__fish_gotham_tx_get_commands)" \
    --no-files
