...
declare -A LIBS
LIBS[cli]="libgotham_cli.a"
LIBS[common]="libgotham_common.a"
LIBS[consensus]="libgotham_consensus.a"
LIBS[crypto]="libgotham_crypto.a"
LIBS[node]="libgotham_node.a"
LIBS[util]="libgotham_util.a"
LIBS[wallet]="libgotham_wallet.a"
...
# https://github.com/gotham/gotham/issues/10102
