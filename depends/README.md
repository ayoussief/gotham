...
Gotham Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Gotham Core

**When configuring Gotham Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Gotham Core:
...
variables will be set when generating the Gotham Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
