...
#ifndef GOTHAM_QT_GOTHAMGUI_H
#define GOTHAM_QT_GOTHAMGUI_H
...
/**
  Gotham GUI main class. This class represents the main window of the Gotham UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GothamGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GothamGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~GothamGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a gotham wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, GothamUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Gotham Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(GothamUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // GOTHAM_QT_GOTHAMGUI_H
