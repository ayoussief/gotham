...
//! Entry point for GothamApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &GothamApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for GothamGUI tests.
void AppTests::guiTests(GothamGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &GothamGUI::consoleShown, this, &AppTests::consoleTests);
