...
{
    // Test regression https://github.com/gotham/gotham/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/gotham-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/gotham-core/gui/pull/568.
    // With fListen=false in ~/.config/Gotham/Gotham-Qt.conf and all else left as default,
    // gotham-qt should set both -listen and -listenonion to false and start successfully.
