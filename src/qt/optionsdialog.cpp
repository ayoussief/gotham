      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->gothamAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->gothamAtStartup);
    ...
    ui->gothamAtStartup->setToolTip(ui->gothamAtStartup->toolTip().arg(CLIENT_NAME));
    ui->gothamAtStartup->setText(ui->gothamAtStartup->text().arg(CLIENT_NAME));

    ui->openGothamConfButton->setToolTip(ui->openGothamConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new GothamUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->gothamAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSGTHontrols);
...
void OptionsDialog::on_openGothamConfButton_clicked()
{
