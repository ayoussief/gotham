...
#ifndef GOTHAM_QT_GUIUTIL_H
#define GOTHAM_QT_GUIUTIL_H
...
/** Utility functions used by the Gotham Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "gotham:" URI into recipient object, return true on successful parsing
