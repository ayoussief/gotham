...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = GothamUnits::formatWithUnit(unit, amount, true, GothamUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    GothamUnit unit{GothamUnit::GTH};
...
{
    GothamUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(GothamUnits::formatWithPrivacy(unit, balances.balance, GothamUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(GothamUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, GothamUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(GothamUnits::formatWithPrivacy(unit, balances.immature_balance, GothamUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(GothamUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, GothamUnits::SeparatorStyle::ALWAYS, m_privacy));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("GTH")
    updateDisplayUnit();
}
