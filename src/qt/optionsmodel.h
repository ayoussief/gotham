...
#ifndef GOTHAM_QT_OPTIONSMODEL_H
#define GOTHAM_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Gotham client.
...
public:
    ...
    GothamUnit getDisplayUnit() const { return m_display_gotham_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSGTHontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    GothamUnit m_display_gotham_unit;
...
Q_SIGNALS:
    void displayUnitChanged(GothamUnit unit);
...
#endif // GOTHAM_QT_OPTIONSMODEL_H
