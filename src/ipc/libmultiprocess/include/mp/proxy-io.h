...
extern thread_local ThreadContext g_thread_context; // NOLINT(gotham-nontrivial-threadlocal)
// Silence nonstandard gotham tidy error "Variable with non-trivial destructor
