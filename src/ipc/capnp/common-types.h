...
#ifndef GOTHAM_IPC_CAPNP_COMMON_TYPES_H
#define GOTHAM_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between gotham processes.
...
//! Functions to serialize / deserialize common gotham types.
namespace mp {
...
#endif // GOTHAM_IPC_CAPNP_COMMON_TYPES_H
