...
// Copyright 2015 Gotham Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef GOTHAM_UNIVALUE_INCLUDE_UNIVALUE_H
#define GOTHAM_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // GOTHAM_UNIVALUE_INCLUDE_UNIVALUE_H
