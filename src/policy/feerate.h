...
#ifndef GOTHAM_POLICY_FEERATE_H
#define GOTHAM_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "GTH"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    GTH_KVB,      //!< Use GTH/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::GTH_KVB) const;
