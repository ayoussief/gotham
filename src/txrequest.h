...
#ifndef GOTHAM_TXREQUEST_H
#define GOTHAM_TXREQUEST_H
 ...
 *   specific transaction. See https://gothamcore.org/en/2024/07/03/disclose_already_asked_for.
 */
