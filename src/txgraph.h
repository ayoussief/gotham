...
#ifndef GOTHAM_TXGRAPH_H
#define GOTHAM_TXGRAPH_H
 ...
 *
 * For more explanation, see https://delvinggotham.org/t/introduction-to-cluster-linearization/1032
 *
