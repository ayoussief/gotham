// Copyright (c) 2015-2021 The Gotham Core developers
 ...
 */
#ifndef GOTHAM_TORCONTROL_H
#define GOTHAM_TORCONTROL_H
...
/****** Gotham specific TorController implementation ********/
