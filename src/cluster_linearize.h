...
#ifndef GOTHAM_CLUSTER_LINEARIZE_H
#define GOTHAM_CLUSTER_LINEARIZE_H
...
public:
     ...
     *
     * See https://delvinggotham.org/t/introduction-to-cluster-linearization/1032 for background.
     */
    ...
    std::pair<SetInfo<SetType>, uint64_t> FindCandidateSet(uint64_t max_iterations, SetInfo<SetType> best) noexcept
    {
        ...
        auto add_fn = [&](SetInfo<SetType> inc, SetType und) noexcept {
            ...
            if (!inc.feerate.IsEmpty()) {
                ...
                //
                // See https://delvinggotham.org/t/how-to-linearize-your-cluster/303 section 2.4.
...
#endif // GOTHAM_CLUSTER_LINEARIZE_H
