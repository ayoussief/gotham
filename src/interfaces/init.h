...
#ifndef GOTHAM_INTERFACES_INIT_H
#define GOTHAM_INTERFACES_INIT_H
...
//! (gotham-gui, gotham-node, gotham-wallet, gothamd, gotham-qt) and each
...
#endif // GOTHAM_INTERFACES_INIT_H
