 ...
 * for both gothamd and gotham-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Satoshi");


#include <gotham-build-info.h>
// The <gotham-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/gotham/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Gotham Core copyright is not removed by accident
    if (copyright_devs.find("Gotham Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Gotham Core developers";
    }
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/gotham/gotham>";
