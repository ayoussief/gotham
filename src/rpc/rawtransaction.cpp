                     ...
                     TxVerbosity verbosity = TxVerbosity::SHOW_DETAILS)
{
    ...
    // Call into TxToUniv() in gotham-common to decode the transaction hex.
    //
    // Blockchain contextual information (confirmations and blocktime) is not
    // available to code in gotham-common, so we query them here and push the
...
static RPCHelpMan decodepsbt()
{
    return RPCHelpMan{
        "decodepsbt",
        "Return a JSON object representing the serialized, base64-encoded partially signed Gotham transaction.",
                {
...
static RPCHelpMan combinepsbt()
{
    return RPCHelpMan{
        "combinepsbt",
        "Combine multiple partially signed Gotham transactions into one transaction.\n"
