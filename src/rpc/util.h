...
#ifndef GOTHAM_RPC_UTIL_H
#define GOTHAM_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting GTH/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1GTH/kvB.
 */
