...
#ifndef GOTHAM_RPC_PROTOCOL_H
#define GOTHAM_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in gothamd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Gotham is not connected
