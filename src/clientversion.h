...
#ifndef GOTHAM_CLIENTVERSION_H
#define GOTHAM_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by gotham-build-config.h or in any other way
#endif
