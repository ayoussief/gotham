...
#ifndef GOTHAM_TEST_SCRIPTNUM10_H
#define GOTHAM_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Gotham Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // GOTHAM_TEST_SCRIPTNUM10_H
