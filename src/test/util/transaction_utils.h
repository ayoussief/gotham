// Copyright (c) 2019-2020 The Gotham Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GOTHAM_TEST_UTIL_TRANSACTION_UTILS_H
#define GOTHAM_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // GOTHAM_TEST_UTIL_TRANSACTION_UTILS_H
