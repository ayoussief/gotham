// Copyright (c) 2015-present The Gotham Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GOTHAM_TEST_UTIL_SETUP_COMMON_H
#define GOTHAM_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/gotham/gotham/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // GOTHAM_TEST_UTIL_SETUP_COMMON_H
