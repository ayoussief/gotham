...
{
    BOOST_CHECK(TestSplitHost("www.gothamcore.org", "www.gothamcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.gothamcore.org]", "www.gothamcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.gothamcore.org:80", "www.gothamcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.gothamcore.org]:80", "www.gothamcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.gothamcore.org:65536", "www.gothamcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.gothamcore.org:0", "www.gothamcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.gothamcore.org:", "www.gothamcore.org:", 0, false));
}
