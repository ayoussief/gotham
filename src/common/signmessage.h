...
#ifndef GOTHAM_COMMON_SIGNMESSAGE_H
#define GOTHAM_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's gotham address, it must refer to a public key.
...
#endif // GOTHAM_COMMON_SIGNMESSAGE_H
