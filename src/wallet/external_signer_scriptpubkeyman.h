// Copyright (c) 2019-2021 The Gotham Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GOTHAM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define GOTHAM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // GOTHAM_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
