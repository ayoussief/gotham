// Copyright (c) 2017-2021 The Gotham Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GOTHAM_WALLET_WALLETUTIL_H
#define GOTHAM_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! gotham from opening the wallet, thinking it was newly created, and
...
#endif // GOTHAM_WALLET_WALLETUTIL_H
