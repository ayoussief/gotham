...
#ifndef GOTHAM_NODE_CONNECTION_TYPES_H
#define GOTHAM_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/gotham-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Gotham’s Peer-to-Peer Network")
...
#endif // GOTHAM_NODE_CONNECTION_TYPES_H
