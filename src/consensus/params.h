...
#ifndef GOTHAM_CONSENSUS_PARAMS_H
#define GOTHAM_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    /**
     * If true, witness commitments contain a payload equal to a Gotham Script solution
...
#endif // GOTHAM_CONSENSUS_PARAMS_H
