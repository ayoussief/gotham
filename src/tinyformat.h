...
#include <algorithm>
#include <attributes.h> // Added for Gotham Core
#include <iostream>
#include <sstream>
#include <stdexcept> // Added for Gotham Core
#include <util/string.h> // Added for Gotham Core
...
// Added for Gotham Core. Similar to std::runtime_format from C++26.
...
// Added for Gotham Core. Wrapper for checking format strings at compile time.
