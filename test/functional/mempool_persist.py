...
By default, gothamd will dump mempool on shutdown and
...
class MempoolPersistTest(GothamTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent gothamd from writing mempool.dat to disk. Verify that `savemempool` fails")
