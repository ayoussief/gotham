...
Verify that a gothamd node can use an external signer command.
...
class RPCSignerTest(GothamTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart gothamd with -signer=<cmd>',
