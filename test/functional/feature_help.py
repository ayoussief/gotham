#!/usr/bin/env python3
# Copyright (c) 2018-2021 The Gotham Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting gotham with -h works as expected."""

from test_framework.test_framework import GothamTestFramework
from test_framework.util import assert_equal

class HelpTest(GothamTestFramework):
    ...
    def run_test(self):
        self.log.info("Start gotham with -h for help text")
        ...
        self.log.info("Start gotham with -version for version information")
        ...
        self.log.info("Start gothamd with -fakearg to make sure it does not start")
