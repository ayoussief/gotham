...
class TransactionTimeRescanTest(GothamTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine GTH and create transactions
        ...
        # generate some gth to create transactions and check blockcount
        ...
        # send 10 gth to user's first watch-only address
        self.log.info('Send 10 gth to user')
        ...
        # send 5 gth to our second watch-only address
        self.log.info('Send 5 gth to user')
        ...
        # send 1 gth to our third watch-only address
        self.log.info('Send 1 gth to user')
