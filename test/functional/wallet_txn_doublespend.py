...
class TxnMallTest(GothamTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 GTH:
        ...
        # First: use raw transaction API to send 1240 GTH to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 GTH coin each
        ...
        # Node0's balance should be starting balance, plus 50GTH for another
        ...
        # Node0's total balance should be starting balance, plus 100GTH for
