...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the GothamTestFramework
    pass


class ExampleTest(GothamTestFramework):
    # Each functional test is a subclass of the GothamTestFramework class.
    ...
    def custom_method(self):
        ...
        GothamTestFramework class so other tests can use it."""
