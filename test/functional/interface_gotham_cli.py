#!/usr/bin/env python3
# Copyright (c) 2017-2022 The Gotham Core developers
...
# The block reward of coinbaseoutput.nValue (50) GTH/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 GTH/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"gotham-cli -h\" for help or \"gotham-cli listwallets\" to see "
...
class TestGothamCli(GothamTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `gotham-cli getblockchaininfo`")
        ...
        # Prevent gotham-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and gotham-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and gotham-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (GTH/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (GTH/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 GTH) to the default wallet.
            ...
            # Test gotham-cli -generate with -rpcwallet in multiwallet mode.
