...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The gothamd node closes feeler connections as soon as a version
...
class P2PAddConnections(GothamTestFramework):
    ...
    def run_test(self):
        ...
        # gothamd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that gothamd sends its own version prior to processing
