...
class GothamChainstateTest(GothamTestFramework):
    def skip_test_if_missing_module(self):
        self.skip_if_no_gotham_chainstate()
    ...
    def run_test(self):
        ...
        self.log.info(f"Testing gotham-chainstate {self.get_binaries().chainstate_argv()} with datadir: {datadir}")
...
if __name__ == "__main__":
    GothamChainstateTest(__file__).main()
