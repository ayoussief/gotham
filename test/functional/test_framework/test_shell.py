...
class TestShell:
    """Wrapper Class for GothamTestFramework.

    The TestShell class extends the GothamTestFramework
    ...
    class __TestShell(GothamTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by GothamTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # GothamTestFramework instances are supposed to be constructed with the path
