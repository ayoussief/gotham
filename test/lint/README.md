...
```sh
DOCKER_BUILDKIT=1 docker build -t gotham-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/gotham -it gotham-linter
```
...
maintained:
* for `src/crc32c`: https://github.com/gotham-core/crc32c-subtree.git (branch gotham-fork)
* for `src/crypto/ctaes`: https://github.com/gotham-core/ctaes.git (branch master)
* for `src/ipc/libmultiprocess`: https://github.com/gotham-core/libmultiprocess (branch master)
* for `src/leveldb`: https://github.com/gotham-core/leveldb-subtree.git (branch gotham-fork)
* for `src/minisketch`: https://github.com/gotham-core/minisketch.git (branch master)
* for `src/secp256k1`: https://github.com/gotham-core/secp256k1.git (branch master)
...
```
git remote add --fetch secp256k1 https://github.com/gotham-core/secp256k1.git
```
