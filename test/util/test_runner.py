...
# Copyright 2016-present The Gotham Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for gotham utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "gotham-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./gotham-util":
        execprog = os.getenv("GOTHAMUTIL", default=execprog)
    elif testObj["exec"] == "./gotham-tx":
        execprog = os.getenv("GOTHAMTX", default=execprog)
