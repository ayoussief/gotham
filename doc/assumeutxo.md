...
Assumeutxo is a feature that allows fast bootstrapping of a validating gothamd
instance.
...
```
$ gotham-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ gotham-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
