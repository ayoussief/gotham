UNIX BUILD NOTES
====================
Some notes on how to build Gotham Core in Unix.
...
memory available when compiling Gotham Core. On systems with less, gcc can be
...
To build Gotham Core without wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Gotham Core can
