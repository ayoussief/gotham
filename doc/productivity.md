...
```sh
cmake --build build --target gothamd gotham-cli
cmake --build build --target gotham-qt
cmake --build build --target bench_gotham
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:gotham/gotham.git
```
