...
The Gotham Core daemon can be configured to act as a trusted "border
router", implementing the gotham wire protocol and relay, making
...
The ZeroMQ feature in Gotham Core requires the ZeroMQ API >= 4.0.0
...
For instance:
    ...
    $ gothamd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubhashtx=tcp://192.168.1.2:28332 \
               -zmqpubhashblock="tcp://[::1]:28333" \
               -zmqpubrawtx=ipc:///tmp/gothamd.tx.raw \
...
From the perspective of gothamd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into gothamd directly. Furthermore, no information is
...
using. Gothamd appends an up-counting sequence number to each
