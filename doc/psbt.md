# PSBT Howto for Gotham Core

Since Gotham Core 0.17, an RPC interface exists for Partially Signed Gotham
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/gotham/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for Gotham transactions that are not fully signed
...
#### Multisig with multiple Gotham Core instances
