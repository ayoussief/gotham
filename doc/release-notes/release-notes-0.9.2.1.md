Gotham Core version 0.9.2.1 is now available from:

  https://gotham.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 GTH to 0.01 GTH
...
- Fix "Start gotham on system login"
