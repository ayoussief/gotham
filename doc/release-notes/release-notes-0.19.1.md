...
Gotham Core version 0.19.1 is now available from:

  <https://gothamcore.org/bin/gotham-core-0.19.1/>
...
From Gotham Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Gotham Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Gotham Core does not yet change appearance when
...
- #17488 fix "gothamd already running" warnings on macOS (fanquake)
