Gotham Core version 27.0 is now available from:

  <https://gothamcore.org/bin/gotham-core-27.0/>
...
- libgothamconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libgothamkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Gotham Core. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Gotham Core would
