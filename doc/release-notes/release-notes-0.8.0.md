Gotham-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/gotham/files/Gotham/gotham-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Gotham
...
New/changed settings (command-line or gotham.conf file)
--------------------------------------------------------
