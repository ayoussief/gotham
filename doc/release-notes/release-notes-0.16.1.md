Gotham Core version 0.16.1 is now available from:

  <https://gothamcore.org/bin/gotham-core-0.16.1/>
...
- #12843 `df38b13` Test starting gothamd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure gothamd processes are cleaned up when tests end (sdaftuar)
