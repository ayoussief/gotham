Gotham Core version 0.9.4 is now available from:

  https://gotham.org/bin/0.9.4/
...
this update is incompatible with the Gotham system and could lead to consensus
forks.

Gotham Core released binaries from https://gotham.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~gotham/+archive/ubuntu/gotham
- A third-party or self-compiled Gotham Core

upgrade to Gotham Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
