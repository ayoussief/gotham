Gotham version 0.5.4 is now available for download at:
http://sourceforge.net/projects/gotham/files/Gotham/gotham-0.5.4/
...
http://gitorious.org/gotham/gothamd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Gotham-Qt notifications under Growl 1.3.
Increase required age of Gotham-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxGotham properly when installing Gotham-Qt over it. (Windows)
