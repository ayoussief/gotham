Gotham Core version *0.15.2* is now available from:

  <https://gothamcore.org/bin/gotham-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in gotham-tx (TheBlueMatt)
