Gotham Core version 0.13.2 is now available from:

  <https://gotham.org/bin/gotham-core-0.13.2/>
...
- #8908 `4a974b2` Update gotham-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow gotham-tx to create v2 transactions (gthdrak)
