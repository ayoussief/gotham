Gotham Core version 0.10.4 is now available from:

  <https://gotham.org/bin/gotham-core-0.10.4/>
...
- #6953 `43c2789` Split gotham-tx into its own package
- #6953 `dfe0d4d` Include gotham-tx binary on Debian/Ubuntu
